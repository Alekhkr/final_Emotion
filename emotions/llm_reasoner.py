...
CRITICALLY IMPORTANT: You must explicitly detect and flag any indicators of severe trauma, fear, clinical depression, suicidal ideation, intimidation, social isolation, and extreme vulnerability.
...
You MUST respond strictly with a valid, parseable JSON object matching this exact schema:
{
  ...
  "psychological_vulnerability_cues": ["Suicidal ideation detected", "Extreme fear of retaliation", "Severe isolation", "None"],
